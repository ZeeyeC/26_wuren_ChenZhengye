...
class Metaclass_YoloConeTrack(type):
...
class YoloConeTrack(metaclass=Metaclass_YoloConeTrack):
    ...
    def __init__(self, **kwargs):
        ...
        from std_msgs.msg import UInt8
        self.tracking_id = kwargs.get('tracking_id', UInt8())
        from std_msgs.msg import String
        self.tracking_state = kwargs.get('tracking_state', String())
        from std_msgs.msg import UInt8
        self.missing_frams = kwargs.get('missing_frams', UInt8())
