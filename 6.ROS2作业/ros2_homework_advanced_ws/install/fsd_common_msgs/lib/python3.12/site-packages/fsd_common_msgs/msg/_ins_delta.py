...
class InsDelta(metaclass=Metaclass_InsDelta):
    ...
    def __init__(self, **kwargs):
        ...
        self.total_omega = kwargs.get('total_omega', float())
        self.total_distance_x = kwargs.get('total_distance_x', float())
        self.total_distance_y = kwargs.get('total_distance_y', float())
