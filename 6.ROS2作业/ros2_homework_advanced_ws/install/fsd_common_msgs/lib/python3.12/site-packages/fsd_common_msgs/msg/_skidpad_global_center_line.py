...
class Metaclass_SkidpadGlobalCenterLine(type):
...
class SkidpadGlobalCenterLine(metaclass=Metaclass_SkidpadGlobalCenterLine):
    ...
    def __init__(self, **kwargs):
        ...
        self.is_reach_mid = kwargs.get('is_reach_mid', bool())
