...
inline void to_yaml(
  const fsd_common_msgs::msg::YoloConeDetectionsTrack & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const fsd_common_msgs::msg::YoloConeDetectionsTrack & msg)
{
  return fsd_common_msgs::msg::to_yaml(msg);
}

template<>
inline const char * data_type<fsd_common_msgs::msg::YoloConeDetectionsTrack>()
{
  return "fsd_common_msgs::msg::YoloConeDetectionsTrack";
}

template<>
inline const char * name<fsd_common_msgs::msg::YoloConeDetectionsTrack>()
{
  return "fsd_common_msgs/msg/YoloConeDetectionsTrack";
}
