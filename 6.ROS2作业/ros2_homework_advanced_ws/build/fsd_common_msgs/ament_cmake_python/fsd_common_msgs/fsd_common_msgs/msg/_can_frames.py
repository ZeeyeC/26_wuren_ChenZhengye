...
class Metaclass_CanFrames(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            if Frame.__class__._TYPE_SUPPORT is None:
                Frame.__class__.__import_type_support__()
...
class CanFrames(metaclass=Metaclass_CanFrames):
        ...
        if self._check_fields:
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 True), \
                "The 'frames' field must be a set or sequence and each value of type 'Frame'"
        self._frames = value
