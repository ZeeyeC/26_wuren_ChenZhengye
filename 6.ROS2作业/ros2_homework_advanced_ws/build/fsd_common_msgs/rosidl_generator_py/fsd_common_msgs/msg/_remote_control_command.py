...
class Metaclass_RemoteControlCommand(type):
...
class RemoteControlCommand(metaclass=Metaclass_RemoteControlCommand):
    ...
    def __init__(self, **kwargs):
        ...
        self.stop = kwargs.get('stop', float())
        self.test1 = kwargs.get('test1', float())
